...
namespace SPH
{
	...
	public:
		...
		Graphics::OpenGL::VertexArray& GetStaticParticleVertexArray() override;
	...
	private:
			...
			public ParticleRenderBufferHandle
		{
			...
			Graphics::OpenGL::VertexArray dynamicParticleVertexArray;

			Graphics::OpenGL::GraphicsBuffer dynamicParticleBufferGL;
		...
		public:
			...
			Graphics::OpenGL::VertexArray& GetVertexArray() override { return dynamicParticleVertexArray; }
		};
		...
		Graphics::OpenGL::VertexArray staticParticleVertexArray;
		Graphics::OpenGL::ImmutableStaticGraphicsBuffer staticParticleBufferGL;
	...
	*/
	...
	private:
		...
		public:
			...
			ResourceLockGuard LockForRendering(Graphics::OpenGL::ImmutableMappedGraphicsBuffer& bufferGL, uintMem bufferSize);

			void PrepareForRendering(Graphics::OpenGL::ImmutableMappedGraphicsBuffer& bufferGL, uintMem bufferSize);
		private:
