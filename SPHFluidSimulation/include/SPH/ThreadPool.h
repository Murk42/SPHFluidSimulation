...
namespace SPH
{
	...
	public:
		...
		/*
			Runs on each thred in thread pool
		*/
		template<typename ... Args, std::invocable<uintMem, uintMem, Args...> F> requires SameAs<std::invoke_result_t<F, uintMem, uintMem, Args...>, uint>
